...
urlpatterns = [
    ...
    path('password-reset/', auth_views.PasswordResetView.as_view(template_name='Auth/password_reset.html', html_email_template_name="Auth/email_reset_template.html", subject_template_name="Auth/password_reset_subject.txt"), name='password_reset'),
